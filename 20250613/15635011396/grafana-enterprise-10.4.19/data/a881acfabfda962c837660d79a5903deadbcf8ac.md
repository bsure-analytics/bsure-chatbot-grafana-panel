...
Call log:
  ...
  - waiting for getByRole('textbox', { name: 'Type your message' })
    ...
    at /home/runner/work/bsure-chatbot-grafana-panel/bsure-chatbot-grafana-panel/tests/panel.spec.ts:24:33
```
...
- main:
  ...
  - heading "Sample Panel 1" [level=6]
  - 'alert "Panel plugin not found: bsure-chatbot-panel"':
    - img
    - text: "Panel plugin not found: bsure-chatbot-panel"
  - heading "Sample Panel 2" [level=6]
  - 'alert "Panel plugin not found: bsure-chatbot-panel"':
    - img
    - text: "Panel plugin not found: bsure-chatbot-panel"
```
