...
- Name: BSure Chatbot Panel E2E Tests >> should handle sending messages and maintain functionality
- Location: /home/runner/work/bsure-chatbot-grafana-panel/bsure-chatbot-grafana-panel/tests/panel.spec.ts:59:7
...
Call log:
  - waiting for getByRole('textbox', { name: 'Type your message' }).first()
    ...
    at /home/runner/work/bsure-chatbot-grafana-panel/bsure-chatbot-grafana-panel/tests/panel.spec.ts:65:24
```
...
- main:
  ...
  - 'alert "Panel plugin not found: bsure-chatbot-panel"'
